...
<?php
    ...
    if(isset($_SESSION['rt'])){
        header("Location: pages/rt/index.php");
        die();
    } else if(isset($_SESSION['warga'])){
        header("Location: pages/warga/index.php");
        die();
    }
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="act-login.php">
                                        ...
                                        <!-- <div class="form-group">
                                            <div class="custom-control custom-checkbox small">
                                                ...
                                                <label class="custom-control-label" for="customCheck">Login Sebagai RT</label>
                                            </div>
                                        </div> -->
                                        <div class="form-group">
                                    ...
                                    <hr>
                                    <div class="text-center">
                                        <a class="small" href="register.php">Form Pendaftaran</a>
                                    </div>
                                </div>
                            </div>
                        </div>
